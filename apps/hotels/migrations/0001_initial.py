# Generated by Django 3.0.11 on 2021-01-11 02:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=50, verbose_name='Nombre o categoria')),
                ('alias', models.CharField(blank=True, max_length=20, null=True, verbose_name='Alias')),
                ('descripcion_corta', models.CharField(max_length=50, verbose_name='Breve descripcion')),
                ('huespedes_permitidos', models.IntegerField(blank=True, null=True, verbose_name='Huespedes permitidos')),
                ...
                ('precio', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='EUR', max_digits=10, verbose_name='Precio de reserva')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(blank=True, max_length=20, null=True, verbose_name='Nombre de la habitacion')),
                ('descripcion_corta', models.CharField(max_length=50, verbose_name='Breve descripcion')),
                ('descripcion', models.TextField(blank=True, null=True, verbose_name='Descripcion')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('tipo_habitacion', models.ManyToManyField(blank=True, to='hotels.TipoHabitacion', verbose_name='Tipo de habitacion')),
            ],
            options={
